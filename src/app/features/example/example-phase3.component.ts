  ...
  template: `
    <div class="max-w-6xl mx-auto p-6">
      ...
      <div class="flex gap-2 mb-6 pb-4 border-b border-gray-200">
        <a href="/" class="text-sm px-3 py-1.5 rounded-md font-medium text-gray-600 hover:bg-gray-100">
          Phase 1: Basic Forms
        </a>
        <a href="/phase2" class="text-sm px-3 py-1.5 rounded-md font-medium text-gray-600 hover:bg-gray-100">
          Phase 2: Advanced Forms
        </a>
        <a href="/phase3" class="text-sm px-3 py-1.5 rounded-md font-medium bg-primary-100 text-primary-700">
